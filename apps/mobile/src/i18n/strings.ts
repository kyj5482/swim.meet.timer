...
export const strings = {
  ...
  // 페이스 요약 — 부모·선수가 그대로 읽을 수 있는 문장(정체는 정상이라는 맥락 포함)
  paceImprovingMo: (v: string) => `Improving · ▼${v}s/mo`,
  paceImproving: 'Improving',
  pacePlateau: 'Holding steady — plateaus are normal',
  paceRegressing: 'Off PB pace lately',
  expandChart: 'Expand',
  ...
  aiCoach: 'AI Coach Account',
  aiCoachHint: 'Sign in to sync records to SplitLane Cloud, share with your coach, and get reviews.',
